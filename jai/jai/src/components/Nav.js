    ...
    return ( <
        ...
        Disclosure as="nav"
                ...
                div className="flex flex-shrink-0 items-center" >
                                                        <
                                                            img className="block h-11 w-auto lg:hidden logo"
                                                            src={logo}
                                                            alt="kst_logo" /
                                                        >
                                                        <
                                                            img className="hidden h-12 w-auto lg:block logo"
                                                            src={logo}
                                                            alt="kst_logo" /
                                                        >
                                                        <
                ...
                li className="mr-2" >
                                                                        ...
                                                                        className = {
                                                                            location.pathname === "/" ?
                                                                                "inline-block p-4 text-blue-700 bg-gray-200 rounded-t-lg active" :
                                                                                "inline-block p-4 rounded-t-lg hover:text-gray-600 hover:bg-gray-100"
                                                                        } >
                                                                        Home <
                /Link> <
                /li> <
                ...
                Link to="project"
                                                                                        className={
                                                                                            location.pathname === "/project/" ||
                                                                                                location.pathname === "/project/private" ?
                                                                                                "inline-block p-4 text-blue-700 bg-gray-200 rounded-t-lg active" :
                                                                                                "inline-block p-4 rounded-t-lg hover:text-gray-600 hover:bg-gray-100"
                                                                                        } >
                                                                                        Project <
        ...
        div className="flex items-center" >
                                                                                                                                                            <
        a href="https://mail.google.com/mail/?view=cm&fs=1&tf=1&to=support@kstinfotech.com"
                                                                                                                                                                rel="noreferrer"
                                                                                                                                                                target={"_blank"}
                                                                                                                                                                className="mr-6 text-sm font-medium text-gray-300 hover:underline" >
                                                                                                                                                                <
        i className="bx bxs-envelope text-white" > < /i> <
        span className="nav_hide" > support @kstinfotech.com < /span> <
        /a> <
        a href="tel:9884818074"
