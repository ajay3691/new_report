    ...
    return ( <
        ...
        > {
            isModalOpen && ( <
                ...
                for its citizens, companies around the world are updating their terms of service agreements to comply. <
                /p> <
                p className = "text-base leading-relaxed text-gray-500 dark:text-gray-400" >
...

        {
            totalRecord > 5 && ( <
                ...
                span className = "font-semibold text-gray-900" > { totalRecord } < /span>{" "}
                Entries <
                /span> <
                ...
                <
                svg className = "w-3.5 h-3.5 me-2 rtl:rotate-180"
                aria - hidden = "true"
                ...
                Prev <
                /button> <
                button disabled = { page * maxDisplayCount >= totalRecord }
                onClick = {
                    () => setPage(page + 1) }
